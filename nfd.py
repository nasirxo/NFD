...
def baliho():
	try:
		...
		print 'ooO--(_)--Ooo'.center(44)
		print ' ' + W
		print ('N F D').center(44)
		print (W + '     [' + G +'Nasir Facebook Database'+ W + ']')
		print ' '
####################################################################
#		    Print In terminal
def show_program():
 ...
 ------------------------------------------------------
    ...
    Author     Nasir Ali 'NexHacker'
    Name       NFD 'Nasir Facebook Database'
    Website   http://nsocial.tk
    CodeName   nasir.xo
    version    full version
    Date       14/06/2017 3:49:22
    Team       NHackers
...
def menu_reaction_ask():
  try:
	...
	cek = raw_input(R + 'nasir.xo' + W + '/' + R + 'Bot' + W + '/' + R + 'Reaction' + W + ' >> ')
...
def bot():
  try:
	...
	cek = raw_input(R + 'nasir.xo' + W +'/' + R +'Bot ' + W + '>> ')
